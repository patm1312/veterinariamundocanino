        ...
        if(!empty($_GET['idPdes'])){
            ...
            while ($a <= 8) {
                if(isset($_POST['d' . $a])){
                    ...
                    if(empty($_POST['d' . $a])){
                        echo '<br>';
                        echo 'variable ' . $a . 'envia y no habia nada en la db';
                        echo '<br>';
                        ...
                        echo '<br>';
                        echo 'variable ' . $a . 'NO envia datos';
                        echo '<br>';
            ...
            try {
                ...
                echo '<br>';
                echo '<br>';
                echo 'datos desp ' . $datos_vac[1];
                echo '<br>';
                echo '<br>';
                echo 'datos dos desp' . $datos_vac[0];
                echo '<br>';
                echo 'proxima fecha es: '  . $date_form;
                echo '<br>';
                echo 'proxima os`racitacion es  ' . $proxVac;
                echo'<br>';                
                $stm = $pdo->prepare($c);
