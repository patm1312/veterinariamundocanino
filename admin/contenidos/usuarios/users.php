...
?>
            ...
            <p class='bottom__gray bottom__gray--margin'>Historial Medico de.. <?php echo $row["nombre"];  ?><a href="">
                        <img src="../assets/images/editar.png" alt="editar">
                </a></p>
            <div class="producto">
            <table class='tableVac ' ">
                <tr  class='trVac'>
                    <th colspan="3" class='thVac thVac--color'>Historial Medico</th>
                </tr>
                <tr class='trVac'>
                    <th class='thVac thVac--block'>Diagnostico</th>
                    <td class='tdVac tdVac--color' >Garu</td>
                </tr>
                <tr class='trVac'>
                    <th class='thVac thVac--block'>Hospitalizacion</th>
                    <td class='tdVac tdVac--color' >Garu</td>
                </tr>
                <tr class='trVac'>
                    <th class='thVac thVac--block'>Fecha Ingreso</th>
