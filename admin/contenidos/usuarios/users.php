...
<!-- utilizo operador ternario, donde verifico el ancho de la pantalla si es mayor a 768px, accediendo a la propiedad outerWidth, si es verdadeero, es true y  si es falso es false: x-data="{open: true}" @resize.window="open = window.outerWidth > 768 ? true :false" , x-show="!open" , x-show="open"-->
                <div id="Hmedico"  class="producto" >
                    ...
                    <tr>
                        ...
                        <tr class='trVac--admin'>
                            <td class='tdVac--admin tdVac--admin--responsive'>
                                ...
                                <div>
                                    <h2>Documentos:</h2>
                                    <p class="tdVac--admin--p" ><?php echo 'opcion de descargar no disponible';  ?></p>
                                </div>
                                <div>
                    ...
                    <table id="HmedicoB"  class='table--admin noneH' >
                        <tr>
                            <th class='thVac--admin' colspan="12"><?php echo $tituloTabla;  ?></th>
                        </tr>
                        <?php
                        ...
                        <tr class='trVac--admin'>
                            ...
                            <td class='tdVac--admin' ><?php echo $fechaRegistro;  ?></td>
                            <td class='tdVac--admin' ><?php echo $rowM["nombre"];  ?></td>
                            <td class='tdVac--admin' ><?php echo $prescripciones;  ?></td>
                            <td class='tdVac--admin' ><?php echo $diagnostico;  ?></td>
                            <td class='tdVac--admin' ><?php echo $hospitalizacion;  ?></td>
                            <td class='tdVac--admin' ><?php echo $fechaIngreso;  ?></td>
                            <td class='tdVac--admin' ><?php echo $fechaAlta;  ?></td>
                            <td class='tdVac--admin' ><?php echo 'opcion de descargar no disponible';  ?></td>
