<?php
echo 'estoy en actualizar producto';
...
<form enctype="multipart/form-data" class="form contact-form" action="contenidos/productos/acciones/updateProducto.php?id=<?php echo $dato_consulta;?>" method="post">
        ...
        <div class="form__body">    
                ...
                <p>EDita el nombre del producto:</p>
                    <input value="<?php echo $nombre; ?>" name="tittle" class="input" type="name"  placeholder="nombre del producto" title="nombre invalido" pattern="[a-zA-Z ]{1,40}$" required >
                <p>Edita la marca del producto:</p>
                    <input value="<?php echo $marca; ?>" name="marca" class="input" type="name"  placeholder="marca del producto" title="marca invalida" pattern="[a-zA-Z ]{1,40}$" required>
