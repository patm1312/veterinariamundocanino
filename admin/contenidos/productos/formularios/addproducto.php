...
<form enctype="multipart/form-data" class="form contact-form" action="contenidos/productos/acciones/addProducto.php" method="post">
        ...
        <div class="form__body">  
                ...
                <p>Elige un nombre para el producto:</p>
                    <input name="tittle" class="input" type="name"  placeholder="nombre del producto" title="nombre invalido" pattern="[a-zA-Z ]{1,40}$" required>

                <p>Elige la marca del producto:</p>
                    <input name="marca" class="input" type="name"  placeholder="marca del producto" title="marca invalida" pattern="[a-zA-Z ]{1,40}$" required>
