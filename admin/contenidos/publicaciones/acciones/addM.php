<?php
    ...
    if(($_FILES['imagen']['size'][0] > $maximo)){
        ...
        header("Location: ../../../index.php?seccion=AdminPublicaciones&accion=addM");
    }else{
        if(($titulo != '')){
            ...
            $c = "INSERT INTO PAdopta (nombre, especie, raza, edad, sexo, talla, esterilizado, color, fechaAlta, estado, foto, publicaciones_idpublicaciones) VALUES(:nombre, :especie, :raza, :edad, :sexo, :talla, :esterilizado, :color, now(), :estado, :foto, :publicacion)";
                try {
