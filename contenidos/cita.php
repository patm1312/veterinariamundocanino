    ...
    <form class="form form__cita" action="contenidos/acciones/cita.php" method="post">
        ...
        <div class="form__body">    
                ...
                <div class="formJs form__radio">
                   Consulta General
                    <input type="radio" id="" name="citaS" value="consulta general"  <?php echo $resultado =  $_SESSION['cita'][0] == 'consulta general' ? 'checked' : ''; ?> />
                </div>
                <div class="formJs form__radio">
                    Peluqueria
                    <input type="radio" id="" name="citaS" value="peluqueria" <?php echo $resultado =  $_SESSION['cita'][0] == 'peluqueria' ? 'checked' : ''; ?>/>
                </div>
                <div class="formJs form__radio">
                    Vacunacion
                    <input type="radio" id="" name="citaS" value="vacunacion" <?php echo $resultado =  $_SESSION['cita'][0] == 'vacunacion' ? 'checked' : ''; ?>/>
                </div>
