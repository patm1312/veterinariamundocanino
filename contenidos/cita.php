<section class="">
    ...
    <form class="form form__cita" action="" method="">
        ...
        <div class="form__body">    
                <h2 class="form__h2" >Elige el servicio</h2>
                ...
                <div class="form__radio">
                    <label for="">Consulta General</label>
                ...
                <div class="form__radio">
                    <label for="">Vacunacion</label>
                    <input type="radio" id="" name="" value="" />
                </div>
      
                <div class="bottom box__bottom box__bottom--logout box__bottom--cita">
                    <a class="bottom box__bottom--logout" href="index.php?seccion=citaUser">continuar</a>
                </div>
                <div class="box__label">
                    <label class="enlace"><input class="enlace__terminos" type="checkbox" id="" value="">Acepto <a class="enlace " href="">Terminos y  Condiciones</a></label>
                </div>
                <a class="" href="">
