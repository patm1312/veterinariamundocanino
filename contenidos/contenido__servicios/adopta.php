                    ...
                    <div class="description_service--box">
                        <a href="">
                            <div class="description_services--img">
                                <img class="img_preview-poster" src="assets/images/dog-default.png" alt="">
                            </div>
                                <div class="description_services--descr">
                                    <h2 class="nav__item nav__item--color">perro</h2>
                                    <p class="p_posterPreview">raza: <span>criollo</span></p>
                                    <p class="p_posterPreview">sexo</p>
                                    <p class="p_posterPreview">talla: <span>Mediano</span></p>
                                </div>
                        </a>
                   </div>
                   <div class="description_service--box">
