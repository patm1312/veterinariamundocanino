<?php
 ...
 if($dominio){
    ...
    if($var_accion_producto){
        $accion_enlace_add = '/veterinaria/admin/index.php?seccion=AdminProductos&accion=addProducto';
        $accion_enlace_path = '/veterinaria/admin/index.php?seccion=AdminProductos&accion=editarProducto';
    }else{
